...
# data <- read.csv("C:/Users/evasi/Documents/M1/S2/Visualisation des données/projet visualisation/DataViz.txt",sep=",",header=T,encoding="UTF-8")
data=read_csv('../DataViz.csv')
```
